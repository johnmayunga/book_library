...
<html>
    ...
    <body>
      <div id="main">
        ...
        <div id="site_content">
            <div class="my-title">Normal Books list</div>
                       ...
                       <?php endif; ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="viewBooksNormal.php?deleteBook=<?=$bookID ?>" OnClick="return confirm('Are you sure you want to delete this book <?= $bookTitle ;?> ?')" class="control-button delete" >Delete</a>
                                </td>
                                <?php endif; ?>
                            </tr>
                        <?php
