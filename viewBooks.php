                       ...
                       <?php endif; ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="viewBooks.php?deleteBook=<?=$bookID ?>" OnClick="return confirm('Are you sure you want to delete this book <?= $bookTitle ;?> ?')" class="control-button delete" >Delete</a>
                                </td>
                                <?php endif; ?>
                            </tr>
                        <?php
