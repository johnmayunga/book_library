...
$level='User'; $level1=''; $gender=''; $filter = '';
...
<html>
    ...
    <body>
      <div id="main">
        ...
        <div id="site_content">
            <div class="my-title">Normal Users</div>
                       ...
                       <?php endif; ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php if($sessionULe == 'Admin') : ?>
                                <td>
                                    <a href="viewUserUsers.php?deleteUser=<?=$userID ?>" OnClick="return confirm('Are you sure you want to delete user <?= $fName." ". $sName; ?> ?')" class="control-button delete" >Delete</a>
                                </td>
                                <?php endif; ?>
                                <?php endif; ?>
                            </tr>
