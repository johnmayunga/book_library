...
$title = 'Users Details';
 if(($sessionULe != 'Admin' ) || $sessionULe == 'Blocked') : 
...
if(isset($_POST['block'])){
    extract($_POST);
    unblock($id, 'Blocked', 'Blocked');
}
$level='Librarian'; $level1=''; $gender=''; $filter = '';
...
<html>
    ...
    <body>
      <div id="main">
        ...
        <div id="site_content">
            <div class="my-title">Librarians List</div>
                       ...
                       <?php endif; ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="viewUserUsers.php" method="POST">
                                        ...
                                        if($uLevel != 'Admin') :
                                            ...
                                            <input type="hidden" name="id" value="<?= $userID; ?>"/>
                                            <?php else : ?>
                                            <input type="submit" class="control-button view" name="block" value="Block"/>
                                            <input type="hidden" name="id" value="<?= $userID; ?>"/>
                                            <?php 
                                            endif; 
                                        else:
                                ...
                                <?php if($sessionULe == 'Admin') : ?>
                                <td>
                                    <a href="viewLibrarianUsers.php?deleteUser=<?=$userID ?>" OnClick="return confirm('Are you sure you want to delete user <?= $fName." ". $sName; ?> ?')" class="control-button delete" >Delete</a>
                                </td>
                                <?php endif; ?>
                                <?php endif; ?>
                            </tr>
