...
$catStatus = 'Deleted'; $catStatus1 = 'Lost'; $state = '0'; $filter = '';
...
<html>
    ...
    <body>
      <div id="main">
        ...
        <div id="site_content">
            <div class="my-title">All Book Lists</div>
            <?php include('AppRoot/Includes/searchForm.inc'); ?>
            <div class="contents-manage">
                <table class="data-table">
                    <tr>
                       <th>#</th><th>Book Title</th><th>Author</th><th>Publisher</th><th>ISBN</th><th>Quantity</th><!--<th>Pages</th><th>Copyright</th>
                       ...
                       <?php endif; ?>
                        ...
                        <?php 
                        $number = 1;
                        foreach (viewBookCount($catStatus, $catStatus1, $state, $filter) as $user) : 
                            extract($user);
                        ?>
                            <tr>
                                <td><?= $number; ?></td>
                                ...
                                <td><?= $bookPub; ?></td>
                                <td><?= $ISBN; ?></td>
                                <td <?php if($quantity < 1) { echo "style='background-color: #80d0c7'"; } else {echo "style='background-color: #80d0c7'"; } ?>><?= $quantity; ?></td>
                                <!--<td><?= $pages; ?></td>
                                <td><?= $copyrightYear; ?></td>
                                ...
                                <td>
                                    <a href="viewBooksAvailable.php?deleteBook=<?=$bookID ?>" OnClick="return confirm('Are you sure you want to delete this book <?= $bookTitle ;?> ?')" class="control-button delete" >Delete</a>
                                </td>
                                <?php endif; ?>
                            </tr>
                        <?php
